...
@section('content')
                ...
                <div class="x_panel">
                    <div style="background-color: red" class="x_content">
                        ...
                        <h4><strong style="float: right; color: white;" >  کاربر گرامی در  نظر داشته باشید که عملیات امتیاز دهی برای هر محصول فقط یکبار قابل انجام است ، امتیاز باید بین 1 تا 5 وارد شود </strong></h4>
                    </div>
                </div>
                                        ...
                                        <div class="well profile_view">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="left col-xs-7">
                                                    ...
                                                    <br/>
                                                    <h2><strong>قیمت واحد (تومان) : </strong>  {{number_format($product->product_price)}} </h2>
                                                    <br/>
                                                ...
                                                <div class="right col-xs-5 text-center">
                                                    @if(!empty($product->productImages[0]))
                                                        <img src="{{url('public/dashboard/productFiles/picture/'.$product->productImages[0]->image_src)}}"  alt="عنوان محصول"  class="img-circle img-responsive"/>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-xs-12 bottom text-center">
                                                <div class="col-xs-12 col-sm-4 emphasis">
                                                    ...
                                                    <p style="margin-top: 3.5%;" title="امتیاز" data-toggle="" class="product-star">
                                                ...
                                                <div id="parent">
                                                    <div  class="col-xs-12 col-sm-4">
                                                        <input type="number" min="1" max="5"    class="col-md-2 form-control input-sm" style="border-radius: 5px;">
                                                    {{--</div>--}}
                                                    {{--<div class="col-xs-12 col-sm-4 emphasis">--}}
                                                        <button  type="button" content="{{$product->id}}" class="btn btn-danger btn-sm col-md-8 col-md-offset-12 addScore" style="border-radius: 5px;"> <i class="fa fa-star"></i> امتیاز دهی </button>
                                                    </div>
                                                </div>
                                                @endif
